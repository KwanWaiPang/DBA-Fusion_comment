...
if __name__ == '__main__':
    ...
    print(f'\033[0;31;42m testing Mono-HKU!!! \033[0m')
    ...
    for (t, image, intrinsics) in tqdm(image_stream(args.imagedir, args.imagestamp, args.enable_h5,\
        ...
        if dbaf is None:
            ...
            [0.99892148, -0.04476788,  0.01231717,  0.00014722,      
             0.04454212,  0.99884479,  0.01803002, -0.00025718,
            -0.0131101, - 0.01746194,  0.99976157,  0.00005513,
