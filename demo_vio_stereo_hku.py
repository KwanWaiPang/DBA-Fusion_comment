...
if __name__ == '__main__':
    ...
    print(f'\033[0;31;42m testing Stereo-HKU!!! \033[0m')
    ...
    for (t, image, intrinsics) in tqdm(image_stream(args.imagedir, args.imagestamp, args.enable_h5,\
        ...
        if dbaf is None:
            ...
            [0.99995523,  0.00599467, -0.00732165, -0.00054603,      
            -0.00603191,  0.99996893, -0.00507505,  0.00046837,
             0.007291,    0.00511898,  0.99996032,  0.06016175,
    ...
    if args.evaluate_flag:
        ...
        result = main_ape.ape(traj_ref, traj_est, 
                pose_relation=PoseRelation.translation_part, align=True,n_to_align=-1, correct_scale=True)#注意n_to_align=-1（align all）
